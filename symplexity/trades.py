...
class RecommendedTrade:
    ...
    def __repr__(self):
        return f"{self.market.base.url} // M {self.mana} {self.outcome} to {self.expected_prob}"
...
def execute_trades(wrapper: api.APIWrapper, trades: list[RecommendedTrade]) -> bool:
    '''
